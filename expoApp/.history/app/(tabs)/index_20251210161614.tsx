  ...
  return (
    <View className="bg-bg flex-1"  >
      ...
      <ScrollView className="px-5  " showsVerticalScrollIndicator={false} contentContainerStyle={{ minHeight: "100%", paddingBottom: 10 }} >
        ...
        {/* //temp links */}
        <View className="flex-row justify-center gap-4 my-4 text-primary-foreground ">
          <Link href="/(auth)" className="p-1 bg-primary text-white rounded-full flex justify-center items-center" >Login</Link>
          <Link href="/(auth)/signup" className="p-1 bg-primary text-white rounded-full flex justify-center items-center" >Signup</Link>
        </View>
