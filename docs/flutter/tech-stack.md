...
- **Optional Service Clients:** Narrow clients can be used for push delivery or monitoring helpers when needed. Firebase should stay utility-only, such as push delivery, rather than becoming the primary backend or identity system.
